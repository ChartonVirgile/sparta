                                  ...
                                  int &n_pre)
{
  ...
  if (reactflag) {
    // will be deleted
    //printf("!!check speceis before isp=%d, jsp=%d, \n",isp,jsp); 
    //printf("!!check speceis after isp=%d, jsp=%d, \n",ip->ispecies,jp->ispecies); 
    ...
    if (kspecies >= 0) {
        ...
        // this energy exchange part is also should be modified
